...
class M_WT {
  ...
  public:
    ...
    M_WT (std::unordered_map<IntType, unsigned>,std::unordered_map<IntType, unsigned>, unsigned, unsigned);
    ...
    void m_by_freq_simon_FullFreq(std::unordered_map<IntType, unsigned>,std::unordered_map<IntType, unsigned>, unsigned);
